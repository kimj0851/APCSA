...
public class Pong extends Canvas implements KeyListener, Runnable
{
	...
	public Pong()
	{
		...
		//ball = new Ball(390,200,10,10,Color.white,1,1);
		
		//ball = new BlinkyBall(100,100,20,20,Color.BLACK,1,1);
		
		//ball = new InvisibleBall(100,100,20,20,Color.BLACK,1,1);
		
		ball = new SpeedUpBall(100,100,20,20,Color.white,1,1);
		
		leftPaddle = new Paddle(30,10,10,100,Color.white,4);
		
		rightPaddle = new Paddle(740,10,10,100,Color.white,4);
		
		leftWall = new Wall(0,0,10 , 800, Color.black);
		rightWall = new Wall(780, 0, 10, 800, Color.black);
