...
public class Ball extends Block implements Collidable
{
   ...
   public void erase(Graphics window) {
	...
	public boolean didCollideLeft(Object obj) {
		...
		if (thing.getX() <= getX() + getWidth() && getY() + getHeight()/2 >= thing.getY() && getY()+ getHeight()/2 <= thing.getY() + thing.getHeight()) {
			return true;
		}
		return false;
	}	
	...
	public boolean didCollideRight(Object obj) {
		...
		Block thing = (Block) obj;
		if (thing.getX() + thing.getWidth() >= getX() && getY() + getHeight()/2 >= thing.getY() && getY()+ getHeight()/2 <= thing.getY() + thing.getHeight()) {
			return true;
		}
		return false;
	}
	...
	public boolean didCollideBottom(Object obj) {
		...
		Block thing = (Block) obj;
		if (getY() <= thing.getY()+getHeight()  && getX() >= thing.getX() && getX() <= thing.getX() + thing.getWidth()) {
			return true;
		}
		return false;
	}
